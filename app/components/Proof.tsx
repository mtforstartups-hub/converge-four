export default function Proof() {
  return (
    <section className="converge-container mx-auto w-full px-14 bg-surface py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-4 bg-canvas">
          <h3 className="font-display text-2xl mb-4 italic">
            &quot;Converge is the first system that performs reasoning with the
            precision of an experienced underwriter. &quot;
          </h3>
