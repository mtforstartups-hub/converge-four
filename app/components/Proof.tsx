        ...
        {testimonialsData.map((testimonial) => {
          ...
          return (
            <div
              ...
              className={`relative p-6 sm:p-10 lg:p-14 bg-canvas border border-neutral-200/60 flex flex-col justify-between group cursor-pointer overflow-hidden outline-none ${isActive ? "is-active" : ""}`}
            >
