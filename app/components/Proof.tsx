export default function Proof() {
  return (
    <section className="converge-container mx-auto w-full px-6 md:px-14 bg-surface py-16 md:py-24 lg:py-32 neon-divider">
      <p className="font-editorial text-base md:text-lg text-pine uppercase tracking-wider">Proof</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-7xl mx-auto">
        <div className="relative p-6 sm:p-10 lg:p-14 bg-canvas border border-neutral-200/60 flex flex-col justify-between group cursor-pointer overflow-hidden">
          ...
          <svg className="absolute top-4 left-4 sm:top-8 sm:left-8 w-12 h-12 sm:w-16 sm:h-16 text-pine/10 transform -translate-x-1 -translate-y-1 sm:-translate-x-2 sm:-translate-y-2 group-hover:text-pine/30 transition-colors duration-500 z-10" fill="currentColor" viewBox="0 0 24 24">
