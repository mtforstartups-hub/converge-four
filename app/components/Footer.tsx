...
export default function Footer() {
  ...
  return (
    <footer className="converge-container bg-canvas text-neutral-900 pt-16 md:pt-24 pb-8 md:pb-12 px-6 md:px-14 font-editorial neon-divider">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 w-full border-b border-neutral-300 pb-12">
        <div className="flex flex-col gap-4">
          ...
          <Image src="/soc_logo.png" alt="SOC Logo" width={100} height={80} />
        </div>
        <div className="flex flex-col gap-2 md:pl-8 lg:pl-20 text-sm md:text-base">
          <div className="text-neutral-700 uppercase font-semibold text-xs tracking-wider mb-2">
            Product
          </div>
          <div className="cursor-pointer hover:text-pine transition-colors">
