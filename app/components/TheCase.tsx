  ...
  return (
    <section className="converge-container mx-auto w-full px-6 md:px-14 bg-canvas py-16 md:py-24 neon-divider">
      ...
      >
        ...
        <FadeIn delay={400} className="h-full flex">
          <div className="border border-neutral-300 hover:border-neutral-900 transition-all duration-300 bg-surface flex flex-col overflow-hidden shadow-sm w-full">
            {/* Top Section */}
        ...
        <FadeIn delay={500} className="h-full flex">
          <div className="border-2 border-pine/30 bg-surface shadow-xs hover:border-pine/60 hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col group w-full">
